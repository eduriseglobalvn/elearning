  ...
  return (
    <main className="grid min-h-screen place-items-center p-4 sm:p-6 lg:p-8">
      <section className="w-full max-w-2xl rounded-[32px] border border-slate-200 bg-white p-6 shadow-[var(--erg-shadow)] sm:p-10">
        <p className="inline-flex rounded-full bg-[rgb(204_0_34_/_0.06)] px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[var(--erg-red)]">404</p>
        <h1 className="mt-4 text-4xl font-black leading-none text-slate-900 sm:text-5xl">Không tìm thấy màn hình</h1>
        <p className="mt-3 text-base leading-7 text-slate-500 sm:text-lg">Route này chưa tồn tại trong bản React + Vite hiện tại.</p>
